...
public class MailUtils {
  ...
  static {
    ...
    try {
      isr = new InputStreamReader(
          new FileInputStream(ResourceUtils.getFile(Constants.CLASSPATH_MAIL_TEMPLATES_ALERT_MAIL_TEMPLATE_FTL)),
          Constants.UTF_8);
   ...
   */
  public static Map<String, Object> sendMails(Collection<String> receivers, String title, String content,
      ShowType showType) {
   ...
   */
  public static Map<String, Object> sendMails(Collection<String> receivers, Collection<String> receiversCc,
      String title, String content, ShowType showType) {
    ...
    if (showType == ShowType.TABLE || showType == ShowType.TEXT) {
      ...
      try {
        ...
        String partContent =
            (showType == ShowType.ATTACHMENT ? "Please see the attachment " + title + Constants.EXCEL_SUFFIX_XLS
   ...
   * @throws Exception
   */
  private static void attachment(Collection<String> receivers, Collection<String> receiversCc, String title,
      String content, String partContent)
      throws Exception {
   ...
   */
  private static MimeMessage getMimeMessage(Collection<String> receivers)
      throws MessagingException {
   ...
   */
  private static Map<String, Object> getStringObjectMap(String title, String content, ShowType showType,
      Map<String, Object> retMap, HtmlEmail email)
      throws EmailException {
